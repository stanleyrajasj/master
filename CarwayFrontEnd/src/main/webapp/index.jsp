...
<body id="myPage" data-spy="scroll" data-target=".navbar"
	...
	<div class="jumbotron text-center">
		<h1>CarWay</h1>
		<p>We specialize in super cars</p>
		<form class="form-inline">
			<button type="button" class="btn btn-info btn-lg">signup</button>
...
<div class="container">
  <form class="form-horizontal" role="form">
	...
	<div class="w3-content w3-section" style="max-width: 500px">
			...
			src="resources/images/car1.jpg" style="width: 200%">
	...
	<div id="cars" class="container-fluid text-center bg-grey">
		<h2>cars</h2>
		<br>
		...
		<div id="myCarousel" class="carousel slide text-center"
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					<h4>
						"This CarWay is the best. I am so happy with the result!"<br>
				...
				<div class="item">
					<h4>
						"Could I... BE any more happy with this CarWay?"<br>
	...
	<!-- Container (shopping Section) -->
	<div id="shopping" class="container-fluid">
